...
const tab1 = require('@/assets/instagram/Tab 1.png');
const tab2 = require('@/assets/instagram/Tab 2.png');
const tab3 = require('@/assets/instagram/Tab 3.png');
const tab4 = require('@/assets/instagram/Tab 4.png');
